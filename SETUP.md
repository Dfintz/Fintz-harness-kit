...
| ----------------------------- | -------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| **Agent Skill** (70+ agents)  | `npx skills add Dfintz/Fintz-harness-kit -g`                                          | The harness **playbook** (`skills/harness/SKILL.md`) — agent guidance on stages/gates/loops |
| **Claude Code plugin**        | `/plugin marketplace add Dfintz/Fintz-harness-kit` then `/plugin install harness-kit` | The plugin bundle (playbook + engine files)                                                 |
