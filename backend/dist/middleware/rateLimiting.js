...
exports.adminRateLimiter = createUserRateLimiter({
    max: 20,
    windowMs: 60 * 1000,
    message: 'Admin operations rate limited. Please try again later.',
});
