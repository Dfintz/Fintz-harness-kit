...
exports.AddFleetVisibilityAndTreatyTemplates1863500000000 = void 0;
const typeorm_1 = require("typeorm");
class AddFleetVisibilityAndTreatyTemplates1863500000000 {
    async up(queryRunner) {
        ...
        await queryRunner.createIndices('fleet_visibility_rules', [
            new typeorm_1.TableIndex({ name: 'idx_fvr_fleet', columnNames: ['fleetId'] }),
            new typeorm_1.TableIndex({ name: 'idx_fvr_org', columnNames: ['organizationId'] }),
        ...
        await queryRunner.createIndices('treaty_templates', [
            new typeorm_1.TableIndex({ name: 'idx_treaty_tpl_org', columnNames: ['organizationId'] }),
            new typeorm_1.TableIndex({ name: 'idx_treaty_tpl_category', columnNames: ['category'] }),
            new typeorm_1.TableIndex({ name: 'idx_treaty_tpl_scope', columnNames: ['scope'] }),
            new typeorm_1.TableIndex({ name: 'idx_treaty_tpl_builtin', columnNames: ['isBuiltIn'] }),
            new typeorm_1.TableIndex({ name: 'idx_treaty_tpl_published', columnNames: ['isPublished'] }),
        ]);
...
exports.AddFleetVisibilityAndTreatyTemplates1863500000000 = AddFleetVisibilityAndTreatyTemplates1863500000000;
//# sourceMappingURL=1863500000000-AddFleetVisibilityAndTreatyTemplates.js.map