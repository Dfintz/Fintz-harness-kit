...
exports.CreateTradingReputationTables1792000000000 = void 0;
class CreateTradingReputationTables1792000000000 {
    ...
    `);
        await queryRunner.query(`CREATE INDEX "IDX_trade_transactions_userId" ON "trade_transactions" ("userId")`);
        await queryRunner.query(`CREATE INDEX "IDX_trade_transactions_routeId" ON "trade_transactions" ("routeId")`);
        await queryRunner.query(`CREATE INDEX "IDX_trade_transactions_organizationId" ON "trade_transactions" ("organizationId")`);
        await queryRunner.query(`CREATE INDEX "IDX_trade_transactions_userId_orgId" ON "trade_transactions" ("userId", "organizationId")`);
        await queryRunner.query(`CREATE INDEX "IDX_trade_transactions_routeId_orgId" ON "trade_transactions" ("routeId", "organizationId")`);
        await queryRunner.query(`CREATE INDEX "IDX_trade_transactions_orgId_executedAt" ON "trade_transactions" ("organizationId", "executedAt")`);
        await queryRunner.query(`
    ...
    `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_trade_user_reputation_userId" ON "trade_user_reputation" ("userId")`);
        await queryRunner.query(`CREATE INDEX "IDX_trade_user_reputation_overallScore" ON "trade_user_reputation" ("overallScore")`);
        await queryRunner.query(`CREATE INDEX "IDX_trade_user_reputation_totalRuns" ON "trade_user_reputation" ("totalRuns")`);
    }
...
exports.CreateTradingReputationTables1792000000000 = CreateTradingReputationTables1792000000000;
//# sourceMappingURL=1792000000000-CreateTradingReputationTables.js.map