...
exports.CreateLootDistributionTables1864200000000 = void 0;
class CreateLootDistributionTables1864200000000 {
    ...
    `);
        await queryRunner.query(`CREATE INDEX "IDX_loot_pools_org_status" ON "loot_pools" ("organizationId", "status")`);
        await queryRunner.query(`CREATE INDEX "IDX_loot_pools_org_activity" ON "loot_pools" ("organizationId", "activityId")`);
        await queryRunner.query(`
    ...
    `);
        await queryRunner.query(`CREATE INDEX "IDX_loot_items_org_pool" ON "loot_items" ("organizationId", "lootPoolId")`);
        await queryRunner.query(`CREATE INDEX "IDX_loot_items_pool_status" ON "loot_items" ("lootPoolId", "status")`);
        await queryRunner.query(`
    ...
    `);
        await queryRunner.query(`CREATE INDEX "IDX_loot_claims_org_pool" ON "loot_claims" ("organizationId", "lootPoolId")`);
        await queryRunner.query(`CREATE INDEX "IDX_loot_claims_item_status" ON "loot_claims" ("lootItemId", "status")`);
...
exports.CreateLootDistributionTables1864200000000 = CreateLootDistributionTables1864200000000;
//# sourceMappingURL=1864200000000-CreateLootDistributionTables.js.map