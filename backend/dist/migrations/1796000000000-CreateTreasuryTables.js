...
exports.CreateTreasuryTables1796000000000 = void 0;
class CreateTreasuryTables1796000000000 {
    ...
    `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_credit_pools_org" ON "credit_pools" ("organizationId")`);
        await queryRunner.query(`
    ...
    `);
        await queryRunner.query(`CREATE INDEX "IDX_credit_txn_org_date" ON "credit_transactions" ("organizationId", "createdAt")`);
        await queryRunner.query(`CREATE INDEX "IDX_credit_txn_pool" ON "credit_transactions" ("creditPoolId")`);
        await queryRunner.query(`CREATE INDEX "IDX_credit_txn_from" ON "credit_transactions" ("fromUserId")`);
        await queryRunner.query(`CREATE INDEX "IDX_credit_txn_to" ON "credit_transactions" ("toUserId")`);
        await queryRunner.query(`
    ...
    `);
        await queryRunner.query(`CREATE INDEX "IDX_org_dues_active" ON "org_dues" ("organizationId", "isActive")`);
        await queryRunner.query(`
    ...
    `);
        await queryRunner.query(`CREATE INDEX "IDX_commissary_items_active" ON "commissary_items" ("organizationId", "isActive")`);
        await queryRunner.query(`CREATE INDEX "IDX_commissary_items_category" ON "commissary_items" ("organizationId", "category")`);
        await queryRunner.query(`
    ...
    `);
        await queryRunner.query(`CREATE INDEX "IDX_commissary_purchases_buyer" ON "commissary_purchases" ("organizationId", "buyerId")`);
        await queryRunner.query(`CREATE INDEX "IDX_commissary_purchases_item" ON "commissary_purchases" ("itemId")`);
    }
...
exports.CreateTreasuryTables1796000000000 = CreateTreasuryTables1796000000000;
//# sourceMappingURL=1796000000000-CreateTreasuryTables.js.map