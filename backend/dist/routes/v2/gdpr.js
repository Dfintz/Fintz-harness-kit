...
router.get('/consent/:consentType/version', auth_1.authenticate, (req, res) => getController().checkConsentVersion(req, res));
...
router.get('/admin/requests', auth_1.authenticate, adminAuth_1.requireAdmin, (req, res) => getController().getAdminGdprRequests(req, res));
router.get('/statistics', auth_1.authenticate, adminAuth_1.requireAdmin, (req, res) => getController().getConsentStatistics(req, res));
router.get('/dashboard', auth_1.authenticate, adminAuth_1.requireAdmin, (req, res) => getController().getComplianceDashboard(req, res));
