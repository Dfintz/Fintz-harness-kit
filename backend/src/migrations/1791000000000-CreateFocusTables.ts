...
/**
 * Sprint 18-E: Create focus preference tables.
 *
 * Persists user and organization gameplay focus preferences that were
 * previously stored in-memory (Map-based) inside FocusService.
 */
export class CreateFocusTables1791000000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX IF NOT EXISTS "IDX_user_focus_preferences_userId" ON "user_focus_preferences" ("userId")`
    );
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX IF NOT EXISTS "IDX_org_focus_preferences_orgId" ON "org_focus_preferences" ("orgId")`
    );
  }
