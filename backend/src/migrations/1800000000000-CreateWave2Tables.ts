...
export class CreateWave2Tables1800000000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.createIndex('dashboards', new TableIndex({ columnNames: ['createdBy'] }));
    ...
    await queryRunner.createIndex(
      'dashboard_widgets',
      new TableIndex({ columnNames: ['dashboardId'] })
    );
    ...
    await queryRunner.createIndex('approval_requests', new TableIndex({ columnNames: ['status'] }));
    await queryRunner.createIndex(
      'approval_requests',
      new TableIndex({ columnNames: ['assignedTo'] })
    );
    await queryRunner.createIndex(
      'approval_requests',
    ...
    await queryRunner.createIndex('equipment', new TableIndex({ columnNames: ['organizationId'] }));
    await queryRunner.createIndex('equipment', new TableIndex({ columnNames: ['ownerId'] }));
    ...
    await queryRunner.createIndex(
      'user_achievements',
      new TableIndex({ columnNames: ['achievementId'] })
    );
    await queryRunner.createIndex('user_achievements', new TableIndex({ columnNames: ['userId'] }));
    await queryRunner.createIndex(
      'user_achievements',
      new TableIndex({ columnNames: ['organizationId'] })
    );
