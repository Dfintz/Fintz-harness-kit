...
export class CreateDiscordBotTables1812000000000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX IF NOT EXISTS "IDX_dgs_org_guild" ON "discord_guild_settings" ("organizationId", "guildId")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_dgs_org" ON "discord_guild_settings" ("organizationId")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_dgs_guild" ON "discord_guild_settings" ("guildId")`
    );
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_cc_guild" ON "channel_counters" ("guildId")`
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX IF NOT EXISTS "IDX_cc_guild_channel" ON "channel_counters" ("guildId", "channelId")`
    );
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX IF NOT EXISTS "IDX_me_guild_user_date" ON "member_engagements" ("guildId", "userId", "date")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_me_guild_date" ON "member_engagements" ("guildId", "date")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_me_user" ON "member_engagements" ("userId")`
    );
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_sr_guild" ON "stat_roles" ("guildId")`
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX IF NOT EXISTS "IDX_sr_guild_role" ON "stat_roles" ("guildId", "roleId")`
    );
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_it_guild" ON "invite_tracking" ("guildId")`
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX IF NOT EXISTS "IDX_it_guild_invited" ON "invite_tracking" ("guildId", "invitedUserId")`
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_it_inviter" ON "invite_tracking" ("inviterUserId")`
    );
  }
